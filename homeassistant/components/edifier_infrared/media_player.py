...
COMMAND_SET_COMMANDS: dict[
    ...
    EdifierCommandSet.R2000DB: {
        MediaPlayerEntityFeature.TURN_ON: (EdifierR2000DBCode.POWER,),
        MediaPlayerEntityFeature.TURN_OFF: (EdifierR2000DBCode.POWER,),
        MediaPlayerEntityFeature.VOLUME_STEP: (
            (EdifierR2000DBCode.VOLUME_UP,),
            (EdifierR2000DBCode.VOLUME_DOWN,),
        ),
        MediaPlayerEntityFeature.VOLUME_MUTE: (EdifierR2000DBCode.MUTE,),
    },
    EdifierCommandSet.R2730DB: {
        MediaPlayerEntityFeature.TURN_ON: (EdifierR2730DBCode.POWER,),
        MediaPlayerEntityFeature.TURN_OFF: (EdifierR2730DBCode.POWER,),
        MediaPlayerEntityFeature.VOLUME_STEP: (
            (EdifierR2730DBCode.VOLUME_UP,),
            (EdifierR2730DBCode.VOLUME_DOWN,),
        ),
        MediaPlayerEntityFeature.VOLUME_MUTE: (EdifierR2730DBCode.MUTE,),
    },
